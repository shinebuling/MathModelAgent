...
class E2BCodeInterpreter(BaseCodeInterpreter):
    ...
    async def _pre_execute_code(self):
        init_code = (
            ...
            "        sns.set_style('whitegrid', {'font.sans-serif': [font, 'DejaVu Sans']})\n"
            "        print('Seaborn中文字体配置完成')\n"
            "    except ImportError:\n"
            "        pass\n"
            "\n"
            "setup_chinese_font()\n"
            ...
            "    elif system == 'Darwin':\n"
            "        fonts = ['Heiti SC', 'Arial Unicode MS']\n"
            "    else:\n"
            ...
            "    try:\n"
            "        import seaborn as sns\n"
            "        sns.set_style('whitegrid', {'font.sans-serif': fonts + ['DejaVu Sans']})\n"
            "    except ImportError:\n"
            "        pass\n"
            "\n"
            "print('提示：如需确保中文显示正确，请在绘图前调用 ensure_chinese_font()')\n"
            "\n"
            "# 导入字体管理器\n"
            ...
            "            if font_manager.findfont(font_prop, fallback_to_default=False) != font_manager.findfont(font_manager.FontProperties(), fallback_to_default=False):\n"
            "                return font_prop\n"
            "        except:\n"
            "            continue\n"
            "    return None\n"
            ...
            "if _chinese_font:\n"
            "    _font_config = {'fontproperties': _chinese_font}\n"
            "    print('3D图中文字体配置完成')\n"
            "else:\n"
            "    _font_config = {}\n"
            "    print('警告：3D图中文字体配置失败')\n"
        )
